...
**For any security vulnerabilities, make sure not to open a public issue.** Please read our [Security Policy](https://github.com/Aster-Privacy/Security/blob/main/SECURITY.md) for instructions on how to properly report a vulnerability.
...
By contributing to any Aster repository, you agree that your contributions will be licensed under [AGPL v3](https://www.gnu.org/licenses/agpl-3.0.en.html). Most Aster repositories are completely open source under AGPL v3.
